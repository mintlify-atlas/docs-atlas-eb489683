...
description: "CruciDrive uses Socket.io over WebSockets for GPS tracking and live chat. All connections require a Supabase JWT passed in the handshake auth object."
---
