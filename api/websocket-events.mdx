...
description: "Complete reference for all Socket.io client-to-server and server-to-client events in CruciDrive, covering GPS location updates and real-time chat messaging."
---
